...
{
	if (region.aW.ai === region.ba.ai)
	{
		return 'on line ' + region.aW.ai;
	}
	return 'on lines ' + region.aW.ai + ' through ' + region.ba.ai;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bf: fragment, bn: host, bD: path, bF: port_, bJ: protocol, bK: query};
	});
...
var $author$project$Main$Input = F9(
	function (text, textarea, password, select, color, date, number, check, file) {
		return {cC: check, cG: color, cL: date, cQ: file, dh: number, dq: password, dA: select, dM: text, d_: textarea};
	});
var $author$project$Form$SimpleFields$Password = 2;
var $author$project$Form$SimpleFields$Text = 0;
var $author$project$Form$SimpleFields$TextArea = 1;
var $author$project$Form$Html$Form = $elm$core$Basics$identity;
var $author$project$Form$Internals$checkHints = F3(
	function (ctx, val, field) {
		var local = A3(
			$elm$core$List$foldl,
			F2(
				function (hint, hints) {
					...
					if (!_v1.$) {
						...
						var e = _v1.a;
						return A2($elm$core$List$cons, e, hints);
					}
				}),
			_List_Nil,
			field.bl);
		var global = A3(
			...
			_List_Nil,
			field.bh);
		return _Utils_ap(local, global);
	});
var $author$project$Form$Internals$updateField = F8(
	function (ctx, val, validation, msg, form, makeForm, field, _continue) {
		var check = function (f) {
			var hints = A3($author$project$Form$Internals$checkHints, ctx, val, f);
			if (!validation.$) {
				return A2(
					_continue,
					_Utils_update(
				...
				return A2(
					...
					_Utils_update(
						f,
						{
							bm: A2($elm$core$List$cons, e, hints)
						}),
					makeForm(form));
			}
		};
...
var $author$project$Form$Internals$formView = F8(
	function (field, form, map1, map2, makeForm, _continue, ctx, val) {
		var fieldView = A2(
			map1,
			function (f) {
				return A8(
					$author$project$Form$Internals$updateField,
					ctx,
					val,
			...
			A2(
				field.d6,
				field.cU(ctx),
				{aH: field.aH, bm: field.bm, aL: field.aL, aS: field.aS, bU: field.bU}));
		return A2(
			$elm$core$List$cons,
			fieldView,
			A2(
				...
				map2(
					function (forms) {
						return A2(_continue, field, forms);
					}),
				A2(form.d6, ctx, val)));
	});
var $elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var $elm$html$Html$map = $elm$virtual_dom$VirtualDom$map;
var $author$project$Form$Internals$validateField = F7(
	function (fieldVal, form, makeForm, field, _continue, ctx, val) {
		var hints = A3($author$project$Form$Internals$checkHints, ctx, val, field);
		var valid = function () {
			var _v1 = _Utils_Tuple2(fieldVal, hints);
			if (_v1.a.$ === 1) {
				if (!_v1.b.b) {
					var e = _v1.a.a;
...
var $author$project$Form$Html$append = F2(
	function (field, _v0) {
		var form = _v0;
		return {
			V: A5(
...
var $author$project$Form$SimpleFields$checkFieldUpdate = F3(
...
var $author$project$Form$SimpleFields$checkFieldView = F2(
	function (_v0, field) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_Nil),
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '', field.aL))
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '', field.aH))
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					A2(
						...
						function (e) {
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('form-hint')
									]),
								_List_fromArray(
									[
...
var $author$project$Form$SimpleFields$checkBox = function (value) {
	return {
...
var $author$project$Form$SimpleFields$colorFieldUpdate = F3(
	function (_v0, msg, state) {
		return _Utils_update(
			state,
			{m: msg});
...
var $author$project$Form$SimpleFields$inputDecoder = function (decoder) {
	return A2(
		...
		A2(
			...
			A2($elm$json$Json$Decode$andThen, decoder, $elm$html$Html$Events$targetValue)));
};
...
var $author$project$Form$SimpleFields$colorFieldView = F2(
	function (_v0, field) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
						...
						[
							...
							_List_fromArray(
								[
									...
									function (str) {
										var r = A3($elm$core$String$slice, 1, 3, str);
										var g = A3($elm$core$String$slice, 3, 5, str);
										var b = A3($elm$core$String$slice, 5, 7, str);
										var _v2 = A4(
											$elm$core$Result$map3,
											$avh4$elm_color$Color$rgb255,
											$rtfeldman$elm_hex$Hex$fromString(r),
											$rtfeldman$elm_hex$Hex$fromString(g),
											$rtfeldman$elm_hex$Hex$fromString(b));
										if (!_v2.$) {
											var color = _v2.a;
											return $elm$json$Json$Decode$succeed(
												$author$project$Form$Field$FieldMsg(color));
										} else {
											var e = _v2.a;
...
var $author$project$Form$SimpleFields$colorField = function (value) {
	return {
		aH: $elm$core$Maybe$Nothing,
		cU: $elm$core$Basics$identity,
		bh: _List_Nil,
...
var $author$project$Form$SimpleFields$dateFieldUpdate = F3(
	function (_v0, msg, state) {
		return _Utils_update(
			state,
			{m: msg});
...
var $justinmimbs$date$Date$toOrdinalDate = function (_v0) {
	...
	return {
		aR: rd - $justinmimbs$date$Date$daysBeforeYear(y),
		b7: y
	};
};
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.b7, 0, date.aR);
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a8: col, cI: contextStack, bG: problem, bO: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bO, s.a8, x, s.d));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{a8: 1, d: s.d, e: s.e, b: s.b + 1, bO: s.bO + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{a8: s.a8 + 1, d: s.d, e: s.e, b: newOffset, bO: s.bO, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bO, s.a8, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{a8: newCol, d: s.d, e: s.e, b: newOffset, bO: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a8: col, bG: problem, bO: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bO, p.a8, p.bG);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a8: 1, d: _List_Nil, e: 1, b: 0, bO: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Form$SimpleFields$dateFieldView = F2(
	function (_v0, field) {
		var datestring = function (date) {
			return A3(
				...
				'0',
				$elm$core$String$fromInt(
					$justinmimbs$date$Date$monthNumber(date))) + ('-' + A3(
				$elm$core$String$padLeft,
				2,
				'0',
				$elm$core$String$fromInt(
								...
								[
									...
									function (str) {
										...
										if (!_v2.$) {
											var date = _v2.a;
											return $elm$json$Json$Decode$succeed(
												$author$project$Form$Field$FieldMsg(
													$elm$core$Maybe$Just(date)));
										} else {
											return $elm$json$Json$Decode$succeed(
												$author$project$Form$Field$FieldMsg($elm$core$Maybe$Nothing));
										}
									}),
									$elm$html$Html$Events$onBlur($author$project$Form$Field$Blur)
								]),
...
var $author$project$Form$SimpleFields$dateField = function (value) {
	return {
		aH: $elm$core$Maybe$Nothing,
		cU: $elm$core$Basics$identity,
		bh: _List_Nil,
...
var $author$project$Form$SimpleFields$fileFieldUpdate = F3(
	function (_v0, msg, state) {
		return _Utils_update(
			state,
			{m: msg});
...
var $author$project$Form$SimpleFields$fileFieldView = F2(
	function (_v0, field) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
							...
							_List_fromArray(
								[
									...
									A3(
										...
										'',
										A2($elm$core$List$intersperse, ', ', field.bU.ap))),
									A2(
									$elm$html$Html$Events$stopPropagationOn,
									'change',
									A2(
										...
										A2(
											...
											function (l) {
												if (!l.b) {
													return $author$project$Form$Field$FieldMsg($elm$core$Maybe$Nothing);
												} else {
													var x = l.a;
													return $author$project$Form$Field$FieldMsg(
...
var $author$project$Form$SimpleFields$fileField = F2(
...
var $author$project$Form$SimpleFields$rangeFieldUpdate = F3(
	function (_v0, msg, state) {
		return _Utils_update(
			state,
			{m: msg});
...
var $author$project$Form$SimpleFields$rangeFieldView = F2(
	function (_v0, field) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
								...
								[
									...
									function (str) {
										...
										if (!_v2.$) {
											var num = _v2.a;
											return $elm$json$Json$Decode$succeed(
												$author$project$Form$Field$FieldMsg(num));
										} else {
											return $elm$json$Json$Decode$fail('Could not parse number');
										}
									}),
									$elm$html$Html$Events$onBlur($author$project$Form$Field$Blur)
								]),
...
var $author$project$Form$SimpleFields$rangeField = F2(
	function (config, value) {
		return {
			aH: $elm$core$Maybe$Nothing,
			cU: $elm$core$Basics$identity,
...
var $author$project$Form$SimpleFields$selectFieldUpdate = F3(
	function (list, msg, state) {
		var find = function (l) {
			find:
			while (true) {
				if (!l.b) {
...
var $author$project$Form$SimpleFields$selectFieldView = F2(
	function (list, field) {
		var options = A2(
			$elm$core$List$map,
			function (a) {
...
var $author$project$Form$SimpleFields$selectMaybeField = F3(
	function (list, config, value) {
		return {
			aH: $elm$core$Maybe$Nothing,
			cU: $elm$core$Basics$identity,
			bh: _List_Nil,
			...
			d6: function (_v1) {
				return $author$project$Form$SimpleFields$selectFieldView(
					A2(
						$elm$core$List$cons,
						$elm$core$Maybe$Nothing,
						A2($elm$core$List$map, $elm$core$Maybe$Just, list)));
...
var $author$project$Form$Html$succeed = F2(
...
var $author$project$Form$SimpleFields$textFieldUpdate = F3(
	function (_v0, msg, state) {
		return _Utils_update(
			state,
			{m: msg});
...
var $author$project$Form$SimpleFields$textFieldView = F2(
	function (_v0, field) {
		var textType = function () {
			...
			switch (_v3) {
				...
				default:
					return $elm$html$Html$Attributes$type_('search');
			}
		}();
						...
						[
							...
							_List_fromArray(
								[
									...
									A2($elm$core$Maybe$withDefault, '', field.aS))
								]),
							_List_Nil),
							A2(
							$elm$html$Html$span,
...
var $author$project$Form$SimpleFields$textField = F2(
	function (config, value) {
		return {
			aH: $elm$core$Maybe$Nothing,
			cU: $elm$core$Basics$identity,
...
var $author$project$Form$Field$withDescription = F2(
	function (description, field) {
		return _Utils_update(
			field,
			{
				aH: $elm$core$Maybe$Just(description)
			});
	});
var $author$project$Form$Field$withLabel = F2(
	function (label, field) {
		return _Utils_update(
			field,
			{
				aL: $elm$core$Maybe$Just(label)
			});
	});
var $author$project$Form$Field$withPlaceholder = F2(
	function (placeholder, field) {
		return _Utils_update(
			field,
			{
				aS: $elm$core$Maybe$Just(placeholder)
			});
	});
var $author$project$Main$form = function () {
	var textArea = A2(
		$author$project$Form$Field$withLabel,
		'Paragraph',
		A2(
			$author$project$Form$SimpleFields$textField,
			{ak: 1},
			''));
	var text = A2(
		$author$project$Form$Field$withLabel,
	...
	var select = A2(
		...
		A3(
			$author$project$Form$SimpleFields$selectMaybeField,
			_List_fromArray(
				['Banana', 'Apple', 'Orange', 'Kiwi', 'Pear', 'Mango', 'Passionfruit']),
			{G: $elm$core$Basics$identity, u: $elm$core$Basics$identity},
			$elm$core$Maybe$Nothing));
	var password = A2(
		$author$project$Form$Field$withPlaceholder,
		'Password',
		A2(
			$author$project$Form$Field$withLabel,
			'Password',
			A2(
				...
				'')));
	var number = A2(
		$author$project$Form$Field$withDescription,
		'Choose a number between 0 and 10',
		A2(
			$author$project$Form$Field$withLabel,
			'Number',
			A2(
				$author$project$Form$SimpleFields$rangeField,
				{aM: 10.0, aO: 0.0, aX: 2.5},
				0.0)));
	var file = A2(
		$author$project$Form$Field$withLabel,
		'Upload file',
		A2(
			$author$project$Form$SimpleFields$fileField,
			{
				ap: _List_fromArray(
					['*'])
			},
	...
	var date = A2(
		$author$project$Form$Field$withLabel,
		'Date',
		$author$project$Form$SimpleFields$dateField($elm$core$Maybe$Nothing));
	var color = A2(
		$author$project$Form$Field$withLabel,
		'Color',
		$author$project$Form$SimpleFields$colorField(
			A3($avh4$elm_color$Color$rgb, 0.5, 0.5, 0.0)));
	var checkBox = A2(
		$author$project$Form$Field$withDescription,
		'By agreeing you accept that you agree with our agreement.',
		A2(
			$author$project$Form$Field$withLabel,
			'Do you agree?',
			$author$project$Form$SimpleFields$checkBox(false)));
	return A2(
		$author$project$Form$Html$append,
		file,
		A2(
							...
							A2(
								...
								A2(
									...
									A2(
										$author$project$Form$Html$append,
										text,
										A2($author$project$Form$Html$succeed, $author$project$Main$Input, $author$project$Main$Input))))))))));
}();
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{aa: $author$project$Main$form},
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			var _v1 = A2($author$project$Form$Html$isValid, 0, model.aa);
			if (!_v1.$) {
...
var $author$project$Form$Html$view = F2(
	function (context, _v0) {
		var form = _v0;
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$html$Html$div,
							_List_Nil,
							A2($author$project$Form$Html$view, 0, model.aa))),
						A2(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		c3: $author$project$Main$init,
		dL: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		d5: $author$project$Main$update,
		d6: $author$project$Main$view
	});
