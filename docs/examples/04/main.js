...
{
	if (region.aZ.al === region.bd.al)
	{
		return 'on line ' + region.aZ.al;
	}
	return 'on lines ' + region.aZ.al + ' through ' + region.bd.al;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c2: 'hidden', cK: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c2: 'mozHidden', cK: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c2: 'msHidden', cK: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c2: 'webkitHidden', cK: 'webkitvisibilitychange' }
		: { c2: 'hidden', cK: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dl, request.ef, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.ef));
		}

		_Http_configureRequest(xhr, request);

		request.cz.a && xhr.setRequestHeader('Content-Type', request.cz.a);
		xhr.send(request.cz.b);
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bi: fragment, br: host, bH: path, bJ: port_, bN: protocol, bO: query};
	});
...
var $author$project$Main$Input = F2(
	function (message, gif) {
		return {aA: gif, dk: message};
	});
			...
			if (!validation.$) {
				...
				return A2(
					...
					_Utils_update(
						f,
						{
							bq: A2($elm$core$List$cons, e, hints)
						}),
					makeForm(form));
			}
		};
	...
	function (field, form, map1, map2, makeForm, _continue, ctx, val) {
		var fieldView = A2(
			...
			A2(
				field.eg,
				field.c_(ctx),
				{aK: field.aK, bq: field.bq, aO: field.aO, aV: field.aV, b$: field.b$}));
		return A2(
			$elm$core$List$cons,
			fieldView,
			A2(
...
var $author$project$Main$SearchFor = function (a) {
	return {$: 0, a: a};
};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'width', '35rem')
						]),
					_List_Nil);
			} else {
			...
			A2(
				...
				function (gif) {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src(gif),
								...
								$author$project$Form$Field$FieldMsg(
									$author$project$Main$Choose(gif)))
							]),
						_List_Nil);
				},
				ctx));
...
var $author$project$Main$gifField = function (value) {
	return {
		aK: $elm$core$Maybe$Nothing,
		c_: $elm$core$Basics$identity,
		bk: _List_Nil,
		bp: _List_Nil,
		bq: _List_Nil,
...
var $author$project$Form$Field$isDefined = F2(
	function (hint, value) {
		if (!value.$) {
			return $elm$core$Result$Ok(0);
		} else {
			return $elm$core$Result$Err(hint);
		}
	});
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '', field.aO)),
							A2(
							element,
							_List_fromArray(
								[
									...
									A2($elm$core$Maybe$withDefault, '', field.aV))
								]),
							_List_Nil),
							A2(
							$elm$html$Html$span,
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2($elm$core$Maybe$withDefault, '', field.aK))
								]))
						])),
					A2(
					$elm$html$Html$div,
...
var $author$project$Form$Field$withPlaceholder = F2(
	function (placeholder, field) {
		return _Utils_update(
			field,
			{
				aV: $elm$core$Maybe$Just(placeholder)
			});
	});
	...
	var gif = A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Form$Field$isDefined('Please choose a gif'))
			]),
		$author$project$Main$gifField(
			{ab: $elm$core$Maybe$Nothing, V: ''}));
	return A2(
		$author$project$Form$Html$append,
		gif,
		A2(
...
var $author$project$Main$GotGifs = function (a) {
	return {$: 1, a: a};
};
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.dP));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cq: false, cz: r.cz, cV: r.cV, bl: r.bl, dl: r.dl, d8: r.d8, b2: r.b2, ef: r.ef}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cz: $elm$http$Http$emptyBody, cV: r.cV, bl: _List_Nil, dl: 'GET', d8: $elm$core$Maybe$Nothing, b2: $elm$core$Maybe$Nothing, ef: r.ef});
};
...
var $author$project$Main$getGifs = function (search) {
	var decoder = A2(
	...
	return $elm$http$Http$get(
		{
			cV: A2($elm$http$Http$expectJson, $author$project$Main$GotGifs, decoder),
			ef: A3(
				...
				_List_fromArray(
					[
						A2($elm$url$Url$Builder$string, 'search_text', search),
						A2($elm$url$Url$Builder$int, 'count', 8),
						A2($elm$url$Url$Builder$int, 'start', 0)
					]))
		});
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{O: $author$project$Main$form, ak: _List_Nil},
		$author$project$Main$getGifs('programmer'));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var fmsg = msg.a;
				var form2 = $author$project$Form$Html$get(model.O);
				var form1 = $author$project$Form$Html$get(fmsg);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{O: fmsg}),
					(!_Utils_eq(form1.aA.V, form2.aA.V)) ? $author$project$Main$getGifs(form1.aA.V) : $elm$core$Platform$Cmd$none);
			case 2:
				var _v1 = A2($author$project$Form$Html$isValid, model.ak, model.O);
				if (!_v1.$) {
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$html$Html$div,
							_List_Nil,
							A2($author$project$Form$Html$view, model.ak, model.O))),
						A2(
